...
define([], function () {
    ...
    var _isAnd = function (objID) {
        return safeTypeCheck(objID, _getMetaTypes()[META_TYPES.And]);
    };
    var _isBuffer = function (objID) {
        return safeTypeCheck(objID, _getMetaTypes()[META_TYPES.Buffer]);
    };
    var _isClock = function (objID) {
        return safeTypeCheck(objID, _getMetaTypes()[META_TYPES.Clock]);
    };
    var _isComplexLogicGate = function (objID) {
        return safeTypeCheck(objID, _getMetaTypes()[META_TYPES.ComplexLogicGate]);
    };
    var _isInputPort = function (objID) {
        return safeTypeCheck(objID, _getMetaTypes()[META_TYPES.InputPort]);
    };
    var _isLogicCircuit = function (objID) {
        return safeTypeCheck(objID, _getMetaTypes()[META_TYPES.LogicCircuit]);
    };
    var _isLogicGateBase = function (objID) {
        return safeTypeCheck(objID, _getMetaTypes()[META_TYPES.LogicGateBase]);
    };
    var _isLogicGatesDiagrams = function (objID) {
        return safeTypeCheck(objID, _getMetaTypes()[META_TYPES.LogicGatesDiagrams]);
    };
    var _isLogicGatesMetaLanguage = function (objID) {
        return safeTypeCheck(objID, _getMetaTypes()[META_TYPES.LogicGatesMetaLanguage]);
    };
    var _isNand = function (objID) {
        return safeTypeCheck(objID, _getMetaTypes()[META_TYPES.Nand]);
    };
    var _isNor = function (objID) {
        return safeTypeCheck(objID, _getMetaTypes()[META_TYPES.Nor]);
    };
    var _isNot = function (objID) {
        return safeTypeCheck(objID, _getMetaTypes()[META_TYPES.Not]);
    };
    var _isNumericIOBase = function (objID) {
        return safeTypeCheck(objID, _getMetaTypes()[META_TYPES.NumericIOBase]);
    };
    var _isNumericInput = function (objID) {
        return safeTypeCheck(objID, _getMetaTypes()[META_TYPES.NumericInput]);
    };
    var _isNumericOutput = function (objID) {
        return safeTypeCheck(objID, _getMetaTypes()[META_TYPES.NumericOutput]);
    };
    var _isOr = function (objID) {
        return safeTypeCheck(objID, _getMetaTypes()[META_TYPES.Or]);
    };
    var _isOutputPort = function (objID) {
        return safeTypeCheck(objID, _getMetaTypes()[META_TYPES.OutputPort]);
    };
    var _isOutputPort2InputPort = function (objID) {
        return safeTypeCheck(objID, _getMetaTypes()[META_TYPES.OutputPort2InputPort]);
    };
    var _isOutputPort2UserOutput = function (objID) {
        return safeTypeCheck(objID, _getMetaTypes()[META_TYPES.OutputPort2UserOutput]);
    };
    var _isPortBase = function (objID) {
        return safeTypeCheck(objID, _getMetaTypes()[META_TYPES.PortBase]);
    };
    var _isPortBase2UserIOBase = function (objID) {
        return safeTypeCheck(objID, _getMetaTypes()[META_TYPES.PortBase2UserIOBase]);
    };
    var _isPortConnection = function (objID) {
        return safeTypeCheck(objID, _getMetaTypes()[META_TYPES.PortConnection]);
    };
    var _isSimpleLogicGate = function (objID) {
        return safeTypeCheck(objID, _getMetaTypes()[META_TYPES.SimpleLogicGate]);
    };
    var _isUserIOBase = function (objID) {
        return safeTypeCheck(objID, _getMetaTypes()[META_TYPES.UserIOBase]);
    };
    var _isUserIOBase2PortBase = function (objID) {
        return safeTypeCheck(objID, _getMetaTypes()[META_TYPES.UserIOBase2PortBase]);
    };
    var _isUserIOBase2UserIOBase = function (objID) {
        return safeTypeCheck(objID, _getMetaTypes()[META_TYPES.UserIOBase2UserIOBase]);
    };
    var _isUserInput = function (objID) {
        return safeTypeCheck(objID, _getMetaTypes()[META_TYPES.UserInput]);
    };
    var _isUserInput2InputPort = function (objID) {
        return safeTypeCheck(objID, _getMetaTypes()[META_TYPES.UserInput2InputPort]);
    };
    var _isUserInputBase = function (objID) {
        return safeTypeCheck(objID, _getMetaTypes()[META_TYPES.UserInputBase]);
    };
    var _isUserInputBase2UserOutput = function (objID) {
        return safeTypeCheck(objID, _getMetaTypes()[META_TYPES.UserInputBase2UserOutput]);
    };
    var _isUserOutput = function (objID) {
        return safeTypeCheck(objID, _getMetaTypes()[META_TYPES.UserOutput]);
    };
    var _isXnor = function (objID) {
        return safeTypeCheck(objID, _getMetaTypes()[META_TYPES.Xnor]);
    };
    var _isXor = function (objID) {
        return safeTypeCheck(objID, _getMetaTypes()[META_TYPES.Xor]);
    };
